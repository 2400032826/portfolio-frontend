export const personalInfo = {
  ...
  highlights: [
    { label: "PCMB Score", value: "580/600", detail: "High Distinction" },
    { label: "AWS Credential", value: "AWS Certified", detail: "Cloud Practitioner" },
    { label: "10th Score", value: "527/625", detail: "84.32%" }
  ],
  aboutDomains: [
...
export const skillsData = [
  ...
  { name: 'Git', category: 'Tools', level: 88, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg', desc: 'Version control workflows, branching, and collaboration.' },
  { name: 'VS Code', category: 'Tools', level: 95, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg', desc: 'Integrated developer environment, debugging, and terminal workflows.' }
];
...
export const certificationsData = [
  {
    ...
    status: "PASS",
    badgeColor: "#ff9900",
    summary: "Validation of foundational cloud concepts, AWS core services, security, architecture, pricing, and support models.",
    details: [
      "Scaled Score: 865 / 1000 (Passing score: 700)",
      "Validation of cloud architecture and AWS core services",
      "Demonstrates expertise in security, compliance, and billing models"
    ]
  },
  {
    id: "ds-internship",
    ...
    issuer: "InAmigos Foundation / Siemens",
    status: "VERIFIED",
    badgeColor: "#00f0ff",
    summary: "Hands-on virtual internship supported by Siemens, covering data analysis pipelines, Python statistical tools, and machine learning fundamentals.",
    details: [
      "8-week intensive virtual internship program",
      "Hands-on data processing, cleaning, and predictive analysis",
      "Supported by Siemens industry technology learning tracks"
    ]
  }
];
...
export const projectsData = [
  {
    id: "slv-fashion-studio",
    title: "SLV Fashion Studio",
    status: "CURRENTLY DEVELOPING",
    type: "FULL-STACK WEB APPLICATION",
    tagline: "Custom E-Commerce & Digital Studio Platform for Apparel Operations",
    description: "SLV Fashion Studio is a modern full-stack web application currently in active development. Designed to streamline custom apparel ordering, dynamic product catalog browsing, and seamless customer management.",
    tech: ["React", "JavaScript", "Tailwind CSS", "Node.js", "MySQL"],
    github: null,
    demo: null,
    featured: true,
    highlights: [
